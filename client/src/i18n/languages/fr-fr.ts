...
export const lang = {
    ...
    buttons: {
        ...
        createFirstGrid: "Créer ma première grille",
    ...
    forms: {
        ...
        right: "Droite",
        bottom: "Bas",
        solutionsGrid: "Grille des solutions",
    ...
    tooltips: {
        ...
        cellSize: "Taille de chaque cellule à l'impression",
        borderSize: "Épaisseur des bordures des cellules",
        outBorderSize: "Épaisseur de la bordure extérieure",
        spaceWidth: "Largeur de l'espace entre les mots",
    },
    shortcuts: {
        title: "Raccourcis clavier",
        moveAround: "Se déplacer dans la grille",
        setDirection: "Changer la direction de saisie",
        toggleDefinition: "Transformer une cellule en définition",
        exitDefinition: "Sortir d'une définition",
        horizontalSplit: "Ajouter un espace horizontal",
        verticalSplit: "Ajouter un espace vertical",
        switchMethod: "Changer le mode de suggestion",
        cycleOrdering: "Changer l'ordre des suggestions",
    },
    empty: {
        title: "Rien ici pour l'instant",
        hint: "Cliquez sur Créer pour commencer, ou importez des grilles existantes.",
    },
    collab: {
        connected: "Connecté",
    ...
    account: {
        savedLocally: "Sauvegardé sur cet appareil",
        synced: "Synchronisé avec le cloud",
        syncCta: "Créez un compte pour accéder à vos grilles depuis n'importe quel appareil",
    },
    register: {
        title: "Inscription",
        pseudo: "Pseudonyme",
    ...
    modes: {
        ...
        normalDesc: "Édition libre",
        checkDesc: "Mettre en évidence les erreurs",
        heatmapDesc: "Probabilités des mots",
        suggestedCheck: "Grille complète — passez en mode Vérification",
    },
    help: {
    ...
    groups: {
        ...
        delete: "Supprimer",
        leave: "Quitter",
        empty: "Vous n'êtes dans aucun groupe pour l'instant.",
        deleteTitle: "Supprimer le groupe",
        deleteConfirm: "Supprimer le groupe « {name} » ? Cette action est irréversible.",
        leaveTitle: "Quitter le groupe",
        leaveConfirm: "Quitter le groupe « {name} » ?",
        filterMine: "Mes {resource}",
        share: "Partager avec un groupe",
