...
export const lang = {
    ...
    buttons: {
        ...
        newBook: "Nuevo libro",
        createFirstGrid: "Crear mi primera cuadrícula",
        ...
        here: "aquí",
        importGrid: "Importar cuadrícula (JSON)",
    },
    titles: {
    ...
    forms: {
        ...
        jsonPlaceholder: "Pega aquí el JSON de tu cuadrícula...",
        title: "Título",
        options: "Opciones",
        default: 'Por defecto',
        solutions: "Soluciones",
    ...
    tooltips: {
        ...
        zoomIn: "Acercar",
        zoomOut: "Alejar",
        gridSettings: "Ajustes de la cuadrícula",
        help: "Atajos de teclado",
        cellSize: "Tamaño de cada celda al imprimir",
        borderSize: "Grosor de los bordes de las celdas",
        outBorderSize: "Grosor del borde exterior",
        spaceWidth: "Ancho del espacio entre palabras",
    },
    shortcuts: {
        title: "Atajos de teclado",
        moveAround: "Moverse por la cuadrícula",
        setDirection: "Cambiar la dirección de escritura",
        toggleDefinition: "Convertir una celda en definición",
        exitDefinition: "Salir de una definición",
        horizontalSplit: "Añadir un espacio horizontal",
        verticalSplit: "Añadir un espacio vertical",
        switchMethod: "Cambiar el modo de sugerencia",
        cycleOrdering: "Cambiar el orden de las sugerencias",
    },
    empty: {
        title: "Aún no hay nada aquí",
        hint: "Haz clic en Crear para empezar, o importa cuadrículas existentes.",
    },
    collab: {
        connected: "Conectado",
    ...
    account: {
        ...
        syncCta: "Crea una cuenta para acceder a tus cuadrículas desde cualquier dispositivo",
    },
    register: {
        title: "Registrarse",
        pseudo: "Nombre de usuario",
        pseudoPlaceholder: "Elige un nombre de usuario",
        email: "Correo electrónico",
        password: "Contraseña",
    ...
    modes: {
        ...
        normalDesc: "Edición libre",
        checkDesc: "Resaltar errores en la cuadrícula",
        heatmapDesc: "Mapa de probabilidad de palabras",
        suggestedCheck: "Cuadrícula completa — cambia al modo Verificación",
    },
    help: {
    ...
    groups: {
        ...
        memberEmailPlaceholder: "miembro{'@'}ejemplo.com",
        add: "Añadir",
        removeMember: "Eliminar",
        edit: "Editar",
        delete: "Eliminar",
        leave: "Salir",
        empty: "Todavía no perteneces a ningún grupo.",
        deleteTitle: "Eliminar grupo",
        deleteConfirm: "¿Eliminar el grupo \"{name}\"? Esta acción no se puede deshacer.",
        leaveTitle: "Salir del grupo",
        leaveConfirm: "¿Salir del grupo \"{name}\"?",
        filterMine: "Mis {resource}",
        share: "Compartir con grupo",
    ...
    profile: {
        ...
        savePseudo: "Guardar nombre de usuario",
